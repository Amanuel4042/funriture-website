...
export const aboutData = {
	story: {
		...
		paragraphs: [
			"In an era of mass-manufactured, flat-pack trends, FurniCraft was born in an independent workshop with a mission to revive timeless joinery and architectural reverence.",
	...
	team: [
		{
			...
			avatar: Avatar1Img,
			bio: "Trained in Copenhagen architecture, Liam leads FurniCraft's minimalist design philosophy.",
		},
		{
			name: "Elena Rostova",
...
export const contactDetails = {
	address: "123 Furniture St., Design District",
...
export const footerData = {
	aboutText:
		"FurniCraft is an independent design house committed to sustainable, catalog-led architectural furniture that elevates everyday life.",
	...
	copyright: `FurniCraft © ${new Date().getFullYear()} — Handcrafted Furniture. All rights reserved.`,
};
